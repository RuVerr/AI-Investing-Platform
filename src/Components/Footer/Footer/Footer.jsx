...
import SocialLogo from "../../../images/icons/logo.png";
      ...
      <div className="footerHandle">
        <div className="footerHandleBox1">
          <div className="socialNetwork">
            <Link to={"/"}>
              <img className="socialNetworkLogo" src={SocialLogo} alt="Footer Logo" />
            </Link>
            ...
            <div className="socialLogos">
              ...
              <a href="https://www.facebook.com/ruverrrrr" target="_blank">
                <img src={fb} alt="SocialLogos" />
              </a>
              <a href="https://www.instagram.com/ruver._/" target="_blank">
