  ...
  return (
    <section className="reviews container">
      ...
      <div className="aboutAndInvest">
        <div className="about">
          <h2>ABOUT NEURALEX</h2>
          <p>
            Neuralex is a project that offers unique opportunities for those seeking not only innovation but also
            involvement in a successful and forward-thinking AI story. We combine cutting-edge technology with creative
            applications, creating a unique space for enthusiasts and early adopters.
          </p>
        </div>
        <div className="investWhy">
          <h2>WHY GET INVOLVED</h2>
          <p>
            Our project is not just another AI initiative. It is an innovative and rapidly developing platform that has
            already made its mark in the tech space. We offer a unique opportunity for early participants to join this
            exciting journey and explore the potential of cutting-edge AI solutions.
          </p>
        </div>
      </div>
    </section>
